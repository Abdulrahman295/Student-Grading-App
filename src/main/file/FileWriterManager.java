...
public class FileWriterManager {
    ...
    private static String formatStudentRecord(Student student, String subjectCode) {
        ...
        double gpa = student.getStudentSubjects().get(subjectCode).getGPA(); // Implement this method based on your logic
        String grade = student.getStudentSubjects().get(subjectCode).getGrade(); // Implement this method based on your logic

        return String.format("%s  %s  %.2f  %s", name, number, gpa, grade);
    }
}
